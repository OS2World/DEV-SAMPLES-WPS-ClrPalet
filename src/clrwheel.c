...
/* PORTING NOTE: the original carried an SCCS what-string here,
 *     static char *MODID = "@(#)clrwheel.c:2.01";
 * Its only purpose was embedding the module version for "what"; it was
 * never referenced by code, and Watcom flags such data as W202 even when
 * #pragma disable_message(202) brackets it.  Removed to keep this port
 * warning-clean; the untouched original stays in orig\CLRWHEEL.C.
 */
