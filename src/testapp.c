	...
	char 	*argv[] )
{
	HAB				hab;
	HMQ				hmq;
	/* Note: the original also declared "QMSG qmsg;" here for a
	 * WinGetMsg loop, but the dialog below is modal (WinDlgBox runs
	 * its own internal message loop), so it was never used.
	 */
